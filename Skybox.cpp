...
Skybox::Skybox() {
	...
	std::string texture_pathes[6] = {
		"assets/skybox/skyboxRT.png",
		"assets/skybox/skyboxLF.png",
		"assets/skybox/skyboxUP.png",
		"assets/skybox/skyboxDN.png",
		"assets/skybox/skyboxFT.png",
		"assets/skybox/skyboxBK.png"
	};
