...
struct PlayMode : Mode {
	...
	std::vector<TutorialState> tutorial_content = {
		...
		{{&space}, {0.4f, 0.4f}, "Note that at any time you can press (1) for the menu\n\nBut you will lose all your progress. Press *space*"},
		{{&save, &load}, {0.4f, 0.4f}, "To keep your progress, you can press (2) to save\n\n and (3) to quick load your latest save\n\nTry it out!"},
